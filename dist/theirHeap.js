...
exports.theirHeapsort = exports.theirRemoveMax = exports.theirHeapify = void 0;
function getLeftChildIndex(n) { return 2 * n + 1; }
function getRightChildIndex(n) { return 2 * n + 2; }
function theirBubbleDown(heap, heapLength, index) {
...
function theirRemoveMax(input, heapLength) {
...
exports.theirRemoveMax = theirRemoveMax;
function theirHeapsort(theArray) {
...
exports.theirHeapsort = theirHeapsort;
